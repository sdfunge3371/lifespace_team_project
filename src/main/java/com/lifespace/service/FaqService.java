...
//		faq.setFaqId(generateNextFaqId());
	...
	public ResponseEntity<?> addFaqError(FaqAddDTO dto, BindingResult bindingResult) {
	...
	// 修改的驗證訊息
	public ResponseEntity<?> updateFaqError(FaqUpdateDTO dto, BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {
			Map<String, String> errors = new HashMap<>();
