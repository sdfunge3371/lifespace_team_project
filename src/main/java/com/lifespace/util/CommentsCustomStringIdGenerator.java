...
public class CommentsCustomStringIdGenerator implements IdentifierGenerator{
	        ...
	        try {
	            ...
	            if (rs.next()) {
	                ...
	                if (maxId != null) {
	                    ...
	                    return "C" + String.format("%03d", num + 1);   // ?改成自己表格的開頭
	                }
	            }
	        } catch (Exception e) {
	            e.printStackTrace();
	        }
	        return "C001"; // default 起始值，?改成自己表格的開頭
	    }
