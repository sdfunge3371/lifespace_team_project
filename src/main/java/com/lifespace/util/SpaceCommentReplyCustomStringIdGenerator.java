...
public class SpaceCommentReplyCustomStringIdGenerator implements IdentifierGenerator {
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) {
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT MAX(space_comment_reply_id) FROM space_comment_reply");
